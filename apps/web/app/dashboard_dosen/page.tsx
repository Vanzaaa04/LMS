    ...
    return (
      <div className="lecturer-dashboard dashboard-content" style={{ justifyContent: 'center', alignItems: 'center', minHeight: '60vh' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          <div style={{ width: '36px', height: '36px', border: '3px solid #e4eded', borderTopColor: '#008080', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
  ...
  return (
    <div className="lecturer-dashboard dashboard-content">
      ...
      <section className="welcome-banner">
        ...
        <div className="banner-content">
          ...
          <p className="banner-subtitle">
            Anda memiliki <strong>{stats.pendingSubmissions} tugas mahasiswa</strong> yang menunggu untuk ditinjau hari ini.
          </p>
        </div>
        <div className="banner-actions">
          ...
          <Link href="/labs" className="btn-outline-white">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="quick-actions">
        <Link href="/dosen/courses/create" className="quick-action-btn">
        ...
        <Link href="/dosen/courses" className="quick-action-btn">
          <div className="quick-action-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M4 19.5A2.5 2.5 0 016.5 17H20" />
              <path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" />
        ...
        <Link href="/labs" className="quick-action-btn">
          <div className="quick-action-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" />
              <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" />
                ...
                return (
                  <div className="course-card" key={course.id}>
                    <div className="course-card-top">
                      <div className={`course-icon-wrap ${isPurple ? "purple" : "teal"}`}>
                        {isPurple ? (
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', borderTop: '1px solid var(--border)', paddingTop: '12px', marginTop: '8px', marginBottom: '14px' }}>
                    ...
                    <div className="course-actions">
                      <Link href={`/dosen/courses/${course.id}`} className="btn-filled">
                        Kelola Mata Kuliah
                      </Link>
                    </div>
                  </div>
              ...
              <div className="empty-course-state">
                <div className="empty-course-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none">
                    <path d="M4.75 6.5A2.75 2.75 0 0 1 7.5 3.75h11.75v13.5H7.5a2.75 2.75 0 0 0-2.75 2.75V6.5Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M4.75 20A2.75 2.75 0 0 1 7.5 17.25h11.75M8.25 8h7.5M8.25 11.25h5.25" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
        ...
        <aside className="submissions-panel">
          ...
          <div className="panel-body">
            <div className="empty-course-state">
              <div className="empty-course-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none">
                  <path d="M7 4.75h7l4.25 4.25v9.25A1.75 1.75 0 0 1 16.5 20H7A1.75 1.75 0 0 1 5.25 18.25V6.5A1.75 1.75 0 0 1 7 4.75Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M14 4.75V9h4.25M8.5 12.25h6.5M8.5 15.25h4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
